...
class QuestionsBankScreen extends StatefulWidget {
  final int classId;
  final int subjectId;
  const QuestionsBankScreen({Key? key,required this.classId,required this.subjectId}) : super(key: key);
          ...
          switch (provider.questionBankResponse!.status) {
            ...
            case Status.COMPLETED:
              return PageView.builder(
                  ...
                  itemCount: provider.questionBankResponse!.data!.questions!.length,
                  itemBuilder: (context, index) {
                    if (answers.length < index + 1) {
                      answers.add(
                        Answer(
                          id: provider.questionBankResponse!.data!
                              .questions![index].id!
                              .toString(),
                          choice: '0',
                        ),
                      ...
                      children: [
                                  ...
                                  SizedBox(
                                    ...
                                    child: TextField(
                                      ...
                                      decoration: InputDecoration(
                                        ...
                                        hintStyle: TextStyle(
                                            fontFamily: 'Montserrat', color: Colors.grey[400]),
                                        hintText: '0',
                                        filled: true,
                          ...
                          children: [
                            Container(
                              decoration: BoxDecoration(
                                ...
                                color: provider.questionBankResponse!.data!.questions![index].choices![0].status == 1
                                    ? Colors.orange[400]
                            ...
                            Positioned(
                              left: provider.questionBankResponse!.data!.questions![index].choices![0].status == 1
                                  ? width - 85
                                  : 5,
                              top: 5,
                              child: Container(
                          ...
                          children: [
                            Container(
                              decoration: BoxDecoration(
                                ...
                                color: provider.questionBankResponse!.data!.questions![index].choices![1].status == 1
                                    ? Colors.orange[400]
                                    : const Color.fromRGBO(70, 73, 81, 1),
                              ),
                              constraints: BoxConstraints.expand(
                            ...
                            Positioned(
                              left: provider.questionBankResponse!.data!.questions![index].choices![1].status == 1
                                  ? width - 85
                                  : 5,
                              top: 5,
                              child: Container(
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    color: provider.questionBankResponse!.data!.questions![index].choices![2].status == 1
                                        ? Colors.orange[400]
                                        : const Color.fromRGBO(
                                        70, 73, 81, 1),
                                  ),
                                ...
                                Positioned(
                                  left: provider.questionBankResponse!.data!.questions![index].choices![2].status == 1
                                      ? width - 85
                                      : 5,
                                  top: 5,
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        shape: BoxShape.circle,
                                        color:
                                        provider.questionBankResponse!.data!.questions![index].choices![2].status == 1
                                            ? const Color.fromRGBO(
                                            70, 73, 81, 1)
                                            : Colors.orange[400]),
                                    child: Center(
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    color: provider.questionBankResponse!.data!.questions![index].choices![3].status == 1
                                        ? Colors.orange[400]
                                        : const Color.fromRGBO(
                                        70, 73, 81, 1),
                                  ),
                                ...
                                Positioned(
                                  left:provider.questionBankResponse!.data!.questions![index].choices![3].status == 1
                                      ? width - 85
                                      : 5,
                                  top: 5,
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        shape: BoxShape.circle,
                                        color:
                                        provider.questionBankResponse!.data!.questions![index].choices![3].status == 1
                                            ? const Color.fromRGBO(
                                            70, 73, 81, 1)
                                            : Colors.orange[400]),
                                    child: Center(
                              ...
                              children: [
                                Container(
                                  decoration: BoxDecoration(
                                    ...
                                    color: provider.questionBankResponse!.data!.questions![index].choices![4].status == 1
                                        ? Colors.orange[400]
                                        : const Color.fromRGBO(
                                        70, 73, 81, 1),
                                  ),
                                ...
                                Positioned(
                                  left: provider.questionBankResponse!.data!.questions![index].choices![4].status == 1
                                      ? width - 85
                                      : 5,
                                  top: 5,
                                  child: Container(
                                    ...
                                    decoration: BoxDecoration(
                                        shape: BoxShape.circle,
                                        color:
                                        provider.questionBankResponse!.data!.questions![index].choices![4].status == 1
                                            ? const Color.fromRGBO(
                                            70, 73, 81, 1)
                                            : Colors.orange[400]),
                                    child: Center(
                        ...
                        Container(
                          ...
                          child: ElevatedButton(
                            ...
                            onPressed: _markController.text.isEmpty?null:(){
                              questions.add(AddQuestionToExam(mark: int.parse(_markController.text),questionId: provider.questionBankResponse!.data!.questions![index].id));
                            },
                            child: const Text(
                              'ADD Question',
                              style: TextStyle(
